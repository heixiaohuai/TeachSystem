$(function(){
   ...
   //修改教师信息表单验证
    ...
    function showCourses(){
        ...
        $.post("/TeachSystem/getinputcoursecount",{},function(count){
            $.post("/TeachSystem/getinputcoursepagestotal",{},function(pagestotal){
                //显示第一页数据
                $.post("/TeachSystem/getinputcoursepages",{"curPage":1},function(inputScore){
                    var content="";
                    $.each(inputScore,function(index,inputscore){
                        content+="<tr id='data'>" +
                            "<td>"+inputscore.num+"</td>"+
                            "<td>"+inputscore.no+"</td>"+
                            "<td>"+inputscore.name+"</td>"+
                            "<td>"+inputscore.cname+"</td>"+
                            "<td>"+inputscore.tname+"</td>"+
                ...
                $("#page").paging({
                    ...
                    callback: function (num) { //回调函数
                        ...
                        $.post("/TeachSystem/getinputcoursepages",{"curPage":num},function(inputScore){
                            var content="";
                            $.each(inputScore,function(index,inputscore){
                                content+="<tr id='data'>" +
                                    "<td>"+inputscore.num+"</td>"+
