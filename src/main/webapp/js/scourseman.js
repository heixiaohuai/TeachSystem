$(function(){
   ...
   //修改教师信息表单验证
    ...
    function showCourses(){
        $.post("/TeachSystem/getmycoursecount",{},function(count){
            $.post("/TeachSystem/getmycoursepagestotal",{},function(pagestotal){
                //显示第一页数据
                $.post("/TeachSystem/getmycoursepages",{"curPage":1},function(courses){
                    var content="";
                ...
                $("#page").paging({
                    ...
                    callback: function (num) { //回调函数
                        ...
                        $.post("/TeachSystem/getmycoursepages",{"curPage":num},function(courses){
                            var content="";
                            $.each(courses,function(index,course){
                                content+="<tr id='data'>" +
                                    "<td>"+course.id+"</td>"+
